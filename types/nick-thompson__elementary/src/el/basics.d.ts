 ...
 * @see node.ConstNode
 */
declare const _const: node.TypeFactory<node.ConstType>;
 ...
 * @see node.SrNode
 */
export declare const sr: node.TypeFactory<node.SrType>;
 ...
 */
export const counter: node.TypeFactory<node.CounterType>;
 ...
 * @see node.Node
 */
export declare const select: node.TypeFactory<node.SelectType>;
